...
bool RequireBytes(Lode::State& vm, const std::vector<Lode::Value>& args, size_t index, const char* operation, Input& output)
{
    if (index >= args.size()) { Error(vm, operation, "expected binary input"); return false; }
    output = ReadBytes(args[index]);
...
bool RequireAlgorithm(Lode::State& vm, const std::vector<Lode::Value>& args, size_t index, const char* operation, std::string& output)
{
...
LODE_MODULE(vm)
{
    ...
    exports.Function("randomBytes", [](Lode::State& vm, const std::vector<Lode::Value>& args) -> Lode::Value {
        uint64_t size = 0;
        if (args.empty() || !ReadInteger(args[0], kMaxRandomBytes, size)) return Error(vm, "randomBytes", "length must be a finite non-negative integer within limit");
    ...
    exports.Function("hexEncode", [](Lode::State& vm, const std::vector<Lode::Value>& args) -> Lode::Value {
    ...
    exports.Function("hexDecode", [](Lode::State& vm, const std::vector<Lode::Value>& args) -> Lode::Value {
    ...
    exports.Function("base64Encode", [](Lode::State& vm, const std::vector<Lode::Value>& args) -> Lode::Value {
    ...
    exports.Function("base64Decode", [](Lode::State& vm, const std::vector<Lode::Value>& args) -> Lode::Value {
    ...
    exports.Function("pemEncode", [](Lode::State& vm, const std::vector<Lode::Value>& args) -> Lode::Value {
    ...
    exports.Function("pemDecode", [](Lode::State& vm, const std::vector<Lode::Value>& args) -> Lode::Value {
    ...
    exports.Function("timingSafeEqual", [](Lode::State& vm, const std::vector<Lode::Value>& args) -> Lode::Value {
    ...
    exports.Function("hash", [](Lode::State& vm, const std::vector<Lode::Value>& args) -> Lode::Value {
    ...
    exports.Function("hmac", [](Lode::State& vm, const std::vector<Lode::Value>& args) -> Lode::Value {
    ...
    exports.Function("hkdf", [](Lode::State& vm, const std::vector<Lode::Value>& args) -> Lode::Value {
        std::string algorithm; Input ikm,salt,info; uint64_t length=0; if(!RequireAlgorithm(vm,args,0,"hkdf",algorithm)||!RequireBytes(vm,args,1,"hkdf",ikm)||args.size()<3||!ReadInteger(args[2],kMaxOutputBytes,length)){return Error(vm,"hkdf","length must be a finite non-negative integer within limit");}
    ...
    exports.Function("pbkdf2", [](Lode::State& vm, const std::vector<Lode::Value>& args) -> Lode::Value {
        std::string algorithm; Input password,salt; uint64_t iterations=0,length=0; if(!RequireAlgorithm(vm,args,0,"pbkdf2",algorithm)||!RequireBytes(vm,args,1,"pbkdf2",password)||!RequireBytes(vm,args,2,"pbkdf2",salt)||args.size()<4||!ReadInteger(args[3],kMaxPbkdf2Iterations,iterations)||iterations==0||args.size()<5||!ReadInteger(args[4],kMaxOutputBytes,length))return Error(vm,"pbkdf2","invalid iteration count or output length");
    ...
    exports.Function("aeadEncrypt", [](Lode::State& vm, const std::vector<Lode::Value>& args) -> Lode::Value {
    ...
    exports.Function("aeadDecrypt", [](Lode::State& vm, const std::vector<Lode::Value>& args) -> Lode::Value {
    ...
    exports.Function("generateKeyPair", [](Lode::State& vm, const std::vector<Lode::Value>& args) -> Lode::Value {
    ...
    exports.Function("sign", [](Lode::State& vm, const std::vector<Lode::Value>& args) -> Lode::Value {
    ...
    exports.Function("verify", [](Lode::State& vm, const std::vector<Lode::Value>& args) -> Lode::Value {
    ...
    exports.Function("encrypt", [](Lode::State& vm, const std::vector<Lode::Value>& args) -> Lode::Value {
    ...
    exports.Function("decrypt", [](Lode::State& vm, const std::vector<Lode::Value>& args) -> Lode::Value {
    ...
    exports.Function("derive", [](Lode::State& vm, const std::vector<Lode::Value>& args) -> Lode::Value {
